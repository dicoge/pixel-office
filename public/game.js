...
const MEMBERS = [
  ...
  { id:'gemini',   label:'Gemini',     role:'🔍 研究',   area:'col1_mid',      offset:{x:-10,y:10} },
  { id:'manus',    label:'Manus',      role:'🎨 UI/UX',  area:'col1_bot',      offset:{x:-10,y:10} },
  { id:'claude',   label:'Claude Code',role:'💻 開發',   area:'col2_top',      offset:{x:20,y:15} },
